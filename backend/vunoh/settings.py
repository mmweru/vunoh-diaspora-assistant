...
# Middleware (fixed - removed incorrect custom middleware)
MIDDLEWARE = [
...
TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
         'DIRS': [BASE_DIR / 'frontend' / 'templates'],  # Removed frontend reference to avoid errors
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
if DATABASE_URL:
    # Only use dj_database_url if DATABASE_URL is set and package is installed
    try:
